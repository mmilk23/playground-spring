...
CREATE TABLE playground_spring.category (
    category_id BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1) PRIMARY KEY,
...
CREATE TABLE playground_spring.product (
    ...
    CONSTRAINT fk_category FOREIGN KEY (category_id) REFERENCES playground_spring.category(category_id)
);